...
import { searchJournals } from "../../util/userApiCalls";
    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static">
        <Toolbar>
          ...
          <img src="/Icon.png" alt="custom" width={40} height={40} style={{ paddingRight: 16 }} />
          <Typography
            variant="h6"
            noWrap
            component="div"
            ...
            <StyledInputBase
             ...
             onKeyDown={async e => {
              if (e.key === 'Enter') {
                ...
                const results = await searchJournals(inputValue);
